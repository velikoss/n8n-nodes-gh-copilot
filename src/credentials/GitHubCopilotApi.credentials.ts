	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			description:
				'GitHub OAuth token from device code flow (starts with gho_). Run the device code flow externally and paste the token here.',
		},
		{
			...
			required: false,
			description:
				'Copilot API endpoint (discovered automatically during first use). Leave empty for auto-discovery.',
		},
	];
