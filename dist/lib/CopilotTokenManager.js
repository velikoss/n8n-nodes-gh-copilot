 ...
 * ```
 */
async function getCopilotToken(oauthToken) {
...
class CopilotTokenManager {
     ...
     */
    constructor(oauthToken, savedEndpoint) {
        this.apiToken = null;
        this.expiresAt = 0;
    ...
    async getValidToken() {
        ...
        const needsRefresh = !this.apiToken || Date.now() >= this.expiresAt - CopilotTokenManager.REFRESH_BUFFER_MS;
        if (needsRefresh) {
...
CopilotTokenManager.REFRESH_BUFFER_MS = 5 * 60 * 1000;
